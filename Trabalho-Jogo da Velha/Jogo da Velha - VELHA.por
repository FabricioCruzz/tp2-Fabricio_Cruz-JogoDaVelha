programa
{
	...
	funcao inicio(){
		...
		efetuarJogada(0, 1, "O", tabuleiroJogoDaVelha)
		efetuarJogada(0, 2, "X", tabuleiroJogoDaVelha)
		efetuarJogada(1, 0, "O", tabuleiroJogoDaVelha)
		efetuarJogada(1, 1, "X", tabuleiroJogoDaVelha)
		efetuarJogada(2, 0, "O", tabuleiroJogoDaVelha)
		efetuarJogada(1, 2, "X", tabuleiroJogoDaVelha)
		efetuarJogada(2, 2, "O", tabuleiroJogoDaVelha)
		efetuarJogada(2, 1, "X", tabuleiroJogoDaVelha)
